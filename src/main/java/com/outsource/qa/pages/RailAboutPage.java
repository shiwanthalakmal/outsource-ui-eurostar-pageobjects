 ...
 */
public class RailAboutPage extends BasicPage {
    ...
    public RailAboutPage check_And_Validate_PageHeader(String title){
        Assert.assertEquals(title,lblAboutTitle.getText());
        return this;
    }
}
